...
Usage:
    ...
    from simple_ui_client.features.doc_converter import DocConverterWorker
    worker = DocConverterWorker(event_bus)
    await worker.start()
    
    # CLI batch processing
    from simple_ui_client.features.doc_converter import BatchWorker, ConverterConfig
...
# Core infrastructure
from simple_ui_client.features.doc_converter.core import (
    OutputManager,
    discover_files,
    FileType,
    check_prerequisites,
...
# UI components
from simple_ui_client.features.doc_converter.ui import ProgressManager

# Workers
from simple_ui_client.features.doc_converter.worker import (
    DocConverterWorker,
    BatchWorker,
    DocumentProcessor,
)
