...
if TYPE_CHECKING:
    from simple_ui_client.features.doc_converter.engine.base import BaseConverter
...
def get_converter() -> "BaseConverter":
    ...
    if sys.platform == "win32":
        ...
        from simple_ui_client.features.doc_converter.engine.windows import WindowsConverter
